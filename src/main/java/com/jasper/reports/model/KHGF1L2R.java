...
@Setter
@Getter
public class KHGF1L2R extends BaseModel {
    ...
    private double hawiFABalanceAmount;
    private double hawiFSBalanceAmount;
    private double arsFABalanceAmount;
    ...
    public void setProperties(String[] values) {
        ...
        this.hawiFABalanceAmount = values.length>=9?((StringUtils.isEmpty(values[8]))?0:Double.parseDouble(values[8])):0;
        this.hawiFSBalanceAmount = values.length>=10?((StringUtils.isEmpty(values[9]))?0:Double.parseDouble(values[9])):0;
        this.arsFABalanceAmount = values.length>=11?((StringUtils.isEmpty(values[10]))?0:Double.parseDouble(values[10])):0;
        this.arsFSBalanceAmount = values.length>=12?((StringUtils.isEmpty(values[11]))?0:Double.parseDouble(values[11])):0;
    }
}
