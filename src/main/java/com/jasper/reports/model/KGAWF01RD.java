...
@Setter
@Getter
public class KGAWF01RD extends BaseModel {
    ...
    public void setProperties(String[] values) {
        ...
        this.lastNameTxt = values.length>=2?(StringUtils.isEmpty(values[1])?"":values[1]):"";
        this.firstNameTxt = values.length>=3?(StringUtils.isEmpty(values[2])?"":values[2]):"";
        this.middleInitialTxt = values.length>=4?(StringUtils.isEmpty(values[3])?"":values[3]):"";
