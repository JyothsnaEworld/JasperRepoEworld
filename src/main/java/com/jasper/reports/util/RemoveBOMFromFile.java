package com.jasper.reports.util;
...
public class RemoveBOMFromFile {
    ...
    public static byte[] removeBom(Path path) throws IOException {
        byte[] contentAfterFirst3Bytes = new byte[0];
        ...
        if (isContainBOM(path)) {
            ...
            // remaining
            contentAfterFirst3Bytes = new byte[bytes.length - 3];
